...
abstract class $CategoryItemCopyWith<$Res> {
  ...
  $Res call({int? id, String name, List<CategoryItem>? children});
}
...
class _$_CategoryItem implements _CategoryItem {
  _$_CategoryItem(
      {this.id, required this.name, final List<CategoryItem>? children})
      : _children = children;
  ...
  @override
  String toString() {
    return 'CategoryItem(id: $id, name: $name, children: $children)';
  }
...
abstract class _CategoryItem implements CategoryItem {
  factory _CategoryItem(
      ...
      final List<CategoryItem>? children}) = _$_CategoryItem;
